...
<?php } ?>
<section class="footer-menu-container container">
	
      <!-- Footer widget area 1 -->
      <?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Footer Menu') ) : else : ?>	
      	  <div class="widget">		
		  	 <h4 class="widgettitle">Widget Menu</h4>
